 ...
 */
public class ControlPanelWorkflowPanelAppNavigationItemsTest
	...
	public void setUp() throws Exception {
		...
		ReflectionTestUtil.setFieldValue(
			_controlPanelWorkflowPanelApp, "_language", language);
	}
	...
	public void testGetPanelAppNavigationItems() throws Exception {
		...
		assertCanonicalNames(
			panelAppNavigationItems, "workflows", "configuration");

		assertParameterValue(
			panelAppNavigationItems.get(0), "tab", "workflows");
		assertParameterValue(
			panelAppNavigationItems.get(1), "tab", "configuration");
	}
