...
public class SearchAdminDisplayContextBuilder {
	...
	protected String getSelectedTab(PermissionChecker permissionChecker) {
		if (!permissionChecker.isOmniadmin()) {
			return SearchAdminNavigationConstants.TABS1_INDEX_ACTIONS;
		}

		String selectedTab = ParamUtil.getString(
			_renderRequest, "tabs1",
			SearchAdminNavigationConstants.TABS1_CONNECTIONS);
		...
		if (!Objects.equals(
			...
			!Objects.equals(
				selectedTab,
				SearchAdminNavigationConstants.TABS1_FIELD_MAPPINGS) &&
			!Objects.equals(
				selectedTab,
				SearchAdminNavigationConstants.TABS1_INDEX_ACTIONS)) {

			return SearchAdminNavigationConstants.TABS1_CONNECTIONS;
		}
